...
Раз уж мы тут JS изучаем, то нужно сказать, что JS поддерживает очень многое из ФП: [монады](https://sptm.dev/2023/monads-in.js/)), [функции высшего порядка](https://sptm.dev/2023/execution-context-in-js/) (и классы высшего порядка :) ) и каррирование, хвостовую рекурсию.
