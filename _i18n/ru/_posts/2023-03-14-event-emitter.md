...
Вообще, если бы мой блог был логичным, то эта статья вышла бы раньше предыдущей [статьи о реактивном программировании](https://sptm.space/ru/2023/reactive-programming/), потому что штуки эти очень похожи.
