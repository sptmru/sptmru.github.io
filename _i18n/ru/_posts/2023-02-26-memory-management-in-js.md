...
Вот мы пишем код, создаем функции, объекты, генераторы, [Proxy и Reflect](https://sptm.space/ru/2023/proxy-and-reflect/), вот это все.
...
По этому поводу можно глянуть [мою статью об асинхронности в JS](https://sptm.space/ru/2023/asynchrony-in-js/), но там не совсем об этом.
...
### Ссылки (не те, что в [HTTP](https://sptm.space/ru/2023/http-in-details/))
...
Тогда одна большая сборка мусора превращается в несколько небольших, и это меньше блокирует поток (а он у нас один, читаем [это](https://sptm.space/ru/2023/asynchrony-in-js/)).
